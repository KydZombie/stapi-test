...
public class GuiMachine extends ContainerBase {
    ...
    void drawPower(int power, int maxPower) {
        this.drawBox(4, 24, 4, this.containerHeight - 96, .2f, 0f, 0f, 1f);
        this.drawBox(4, 24, getPowerHeight(power, maxPower), this.containerHeight - 96, .7f, 0f, 0f, 1f);
    }
...
class PowerBar {
    ...
    public PowerBar(int topLeft, int topRight, int bottomLeft, int bottomRight, boolean vertical) {
