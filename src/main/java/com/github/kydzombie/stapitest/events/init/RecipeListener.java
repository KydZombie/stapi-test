...
public class RecipeListener {
    ...
    public void registerRecipes(RecipeRegisterEvent event) {
        if (event.recipeId.equals(RecipeRegisterEvent.Vanilla.SMELTING.type())) {
            ...
            CraftingRegistry.addShapedRecipe(new ItemInstance(StapiTest.battery, 1, StapiTest.batteryItem.getDurability()), " C ", "PRP", "PRP", 'C', StapiTest.powerCable, 'P', StapiTest.ironPlate, 'R', ItemBase.redstoneDust);
            ...
            CraftingRegistry.addShapedRecipe(new ItemInstance(StapiTest.diamondDrill, 1, StapiTest.drill.getDurability()), "PD", "HP", 'P', StapiTest.goldPlate, 'D', StapiTest.diamondDrillHead, 'H', StapiTest.powerToolHandle);
            CraftingRegistry.addShapedRecipe(new ItemInstance(StapiTest.diamondSaw, 1, StapiTest.drill.getDurability()), "PS", "HP", 'P', StapiTest.goldPlate, 'S', StapiTest.diamondSawHead, 'H', StapiTest.powerToolHandle);
